    ...
    return (
        <div className="drawer lg:drawer-open min-h-screen bg-base-200">
            ...
            <div className="drawer-content flex flex-col">
                {/* Navbar */}
                <div className="w-full navbar bg-base-100/50 backdrop-blur-md sticky top-0 z-30 border-b border-base-200 px-4 md:px-8">
                ...
                <div className="w-full max-w-[1600px] p-6 md:p-10 animate-fade-in mx-auto">
                    <Outlet />
                </div>
            </div>
